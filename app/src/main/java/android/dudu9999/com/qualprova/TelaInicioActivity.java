    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        switch ((int)drawerItem.getIdentifier()){
                            ...
                            case 10:
                                  startActivity(new Intent(TelaInicioActivity.this, PerfilActivity.class));
                                break;

                            case 20:
                                //it = new Intent(TelaInicioActivity.this, PerfilActivity.class);
                               // startActivity(it);
                                break;
                        }
                        return false;
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(TelaInicioActivity.this, CadastroActivity.class);
                        ...
                        try {
                            ...
                            while( keys.hasNext() ) {
                                ...
                                if ( jsonObject.get(key) instanceof JSONObject ) {
                                    ...
                                    Prova prov1 = new Prova(tipo, materia, data, colegio, turmas, conteudo, key);
                                        provs.add(0, prov1);
                                }
                            }
